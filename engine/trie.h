...
struct Trie {
    ...
    std::vector<std::string> dump(Node cur, const std::string prefix) {
    ...
    std::vector<std::string> dump(const std::string prefix = "") {
